...
namespace BrunoMikoski.TextJuicer.Modifiers
{
    ...
    public sealed class TextJuicerWarpModifier : TextJuicerVertexModifier
    {
        ...
        [SerializeField]
        private AnimationCurve warpCurve = new AnimationCurve( new Keyframe( 0, 0 ), new Keyframe( 0.25f, 2.0f ),
                                                               new Keyframe( 0.5f, 0 ), new Keyframe( 0.75f, 2.0f ),
                                                               new Keyframe( 1, 0f ) );

        [SerializeField]
        private AnimationCurve intensityCurve = new AnimationCurve( new Keyframe( 0, 0 ), new Keyframe( 1, 1 ) );
            ...
            TMP_MeshInfo[] meshInfo )
        {
            ...
            Vector3 offsetToMidBaseline = new Vector2(
                (vertices[characterDataVertexIndex + 0].x + vertices[characterDataVertexIndex + 2].x) / 2,
